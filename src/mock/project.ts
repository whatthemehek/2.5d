...
export const layers: Layer[] = [
  { id: 'foreground', name: 'Foreground', depth: 900, color: '#6b8145' },
  { id: 'character', name: 'Character', depth: 420, color: '#db735a', components: [{ id: 'head', name: 'Head' }, { id: 'body', name: 'Body' }, { id: 'left-arm', name: 'Left Arm' }, { id: 'right-arm', name: 'Right Arm' }] },
